...
| `home_phone` | [`HomePhone`](../../doc/models/home-phone.md) | Optional | The home phone provided by the Cardholder. Refer to ITU-E.164 for additional information on format and length.<br><br>This field is required if available, unless market or regional mandate restricts sending this information. |
| `mobile_phone` | [`MobilePhone`](../../doc/models/mobile-phone.md) | Optional | The mobile phone provided by the Cardholder. Refer to ITU-E.164 for additional information on format and length.<br><br>This field is required if available, unless market or regional mandate restricts sending this information. |
| `work_phone` | [`WorkPhone`](../../doc/models/work-phone.md) | Optional | The work phone provided by the Cardholder. Refer to ITU-E.164 for additional information on format and length.<br><br>This field is required if available, unless market or regional mandate restricts sending this information. |
...
| `shipping_address` | [`ShippingAddress`](../../doc/models/shipping-address.md) | Optional | Cardholder shipping address object |
