...
| `terminal_api_id` | `String` | Optional | Advance Deposit<br><br>**Constraints**: *Maximum Length*: `36` |
| `e_format` | `Object` | Optional | - |
| `e_track_data` | `String` | Optional | Encrypted Track Data |
| `e_serial_number` | `String` | Optional | Encrypted Track Data KSN<br><br>**Constraints**: *Maximum Length*: `20` |
