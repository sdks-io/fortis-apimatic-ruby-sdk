...
|  --- | --- | --- | --- |
| `type` | [`Type78Enum`](../../doc/models/type-78-enum.md) | Optional | Resource Type<br><br>**Default**: `Type78Enum::TAGSCOLLECTION` |
| `list` | [`Array[List13]`](../../doc/models/list-13.md) | Optional | Resource Members |
