...
| `contact_id` | `String` | Optional | Contact<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
...
| `email` | `String` | Required | Email<br><br>**Constraints**: *Maximum Length*: `128` |
...
| `primary_location_id` | `String` | Required | Primary Location ID<br><br>**Constraints**: *Pattern*: `^(([0-9a-fA-F\-]{24,36})\|(([0-9a-fA-F]{8})-(([0-9a-fA-F]{4}\-){3})([0-9a-fA-F]{12})))$` |
...
| `ui_prefs` | [`UiPrefs1`](../../doc/models/ui-prefs-1.md) | Optional | - |
| `username` | `String` | Required | Username<br><br>**Constraints**: *Minimum Length*: `2`, *Maximum Length*: `64` |
...
| `user_type_code` | [`UserTypeCode`](../../doc/models/user-type-code.md) | Required | - |
