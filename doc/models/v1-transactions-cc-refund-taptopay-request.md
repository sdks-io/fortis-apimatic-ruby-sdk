...
| `card_data_cryptogram` | `String` | Required | Encrypted Cardholder data. Used in Tap to Pay transactions |
| `general_card_data` | `String` | Required | Plaintext EMV tags. Used in Tap to Pay transactions |
| `card_reader_id` | `String` | Optional | Identifier of card reader used in Tap to Pay transactions. |
