...
| `item_list` | [`Array[ItemList]`](../../doc/models/item-list.md) | Optional | Item List<br><br>**Constraints**: *Minimum Items*: `1`, *Maximum Items*: `300`, *Unique Items Required* |
...
| `files` | [`Array[File]`](../../doc/models/file.md) | Optional | File Information on `expand` |
