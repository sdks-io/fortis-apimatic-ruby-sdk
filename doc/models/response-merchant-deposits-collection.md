...
|  --- | --- | --- | --- |
| `type` | [`Type48Enum`](../../doc/models/type-48-enum.md) | Optional | Resource Type<br><br>**Default**: `Type48Enum::MERCHANTDEPOSITSCOLLECTION` |
| `list` | [`Array[List8]`](../../doc/models/list-8.md) | Optional | Resource Members |
