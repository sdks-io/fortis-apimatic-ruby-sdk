...
|  --- | --- | --- | --- |
| `type` | [`Type6Enum`](../../doc/models/type-6-enum.md) | Optional | Resource Type<br><br>**Default**: `Type6Enum::CONTACTSEARCHSCOLLECTION` |
| `list` | [`Array[List1]`](../../doc/models/list-1.md) | Optional | Resource Members |
