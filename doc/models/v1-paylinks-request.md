...
| `amount_due` | `Integer` | Required | This is the amount that need to be paid (automatically calculated by system). amount_due= sum of items in item_list<br><br>**Constraints**: `>= 1`, `<= 999999999` |
...
| `delivery_method` | `Object` | Optional | - |
...
| `paylink_action` | `Object` | Optional | - |
