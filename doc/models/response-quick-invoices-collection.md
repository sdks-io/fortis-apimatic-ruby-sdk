...
|  --- | --- | --- | --- |
| `type` | [`Type62Enum`](../../doc/models/type-62-enum.md) | Optional | Resource Type<br><br>**Default**: `Type62Enum::QUICKINVOICESCOLLECTION` |
| `list` | [`Array[List10]`](../../doc/models/list-10.md) | Optional | Resource Members |
