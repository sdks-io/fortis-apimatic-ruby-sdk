...
|  --- | --- | --- | --- |
| `first_name` | `String` | Optional | Signer's first name<br><br>**Constraints**: *Maximum Length*: `20` |
| `last_name` | `String` | Optional | Signer's last name<br><br>**Constraints**: *Maximum Length*: `20` |
