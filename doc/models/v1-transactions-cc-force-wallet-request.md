...
| `wallet_data` | `String` | Required | Wallet Data |
| `wallet_provider` | [`WalletProvider`](../../doc/models/wallet-provider.md) | Required | - |
| `wallet_key_id` | `String` | Optional | Wallet Key ID |
