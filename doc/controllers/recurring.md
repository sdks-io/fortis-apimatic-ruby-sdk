...
body = V1RecurringsRequest.new(
  ...
  true,
  '192.168.0.10',
  'recurring custom data 1',
  'recurring custom data 2',
  'recurring custom data 3',
  true,
  nil,
  100
)
...
| `fields` | [`Array[Field43Enum]`](../../doc/models/field-43-enum.md) | Query, Optional | You can use any `field_name` from this endpoint results to filter the list of fields returned on the response. |
