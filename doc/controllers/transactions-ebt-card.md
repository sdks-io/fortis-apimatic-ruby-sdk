...
```ruby
transactions_ebt_card_controller = client.transactions_ebt_card
```
...
```ruby
body = V1TransactionsEbtVoucherClearRefundKeyedRequest.new(
  '5454545454545454',
  '0722',
  'abc12345',
  [],
...
```ruby
body = V1TransactionsEbtVoucherClearSaleKeyedRequest.new(
  '5454545454545454',
  '0722',
  'abc12345',
  [],
