...
module FortisApi
  ...
  class V1TransactionsAuthIncrementRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(transaction_amount:, additional_amounts: SKIP,
                   ...
                   deferred_auth: SKIP, mini_bar: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsAuthIncrementRequest.new(transaction_amount: transaction_amount,
    ...
    def to_s
      ...
      " #{@auto_decline_zip_override}, ebt_type: #{@ebt_type}, deferred_auth: #{@deferred_auth},"\
      " mini_bar: #{@mini_bar}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@ebt_type.inspect}, deferred_auth: #{@deferred_auth.inspect}, mini_bar:"\
      " #{@mini_bar.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
