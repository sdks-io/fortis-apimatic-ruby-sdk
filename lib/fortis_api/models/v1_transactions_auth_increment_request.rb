...
module FortisApi
  ...
  class V1TransactionsAuthIncrementRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsAuthIncrementRequest.new(transaction_amount,
                                             additional_amounts,
                                             billing_address,
                                             checkin_date,
                                             checkout_date,
    ...
    def to_s
      ...
      " mini_bar: #{@mini_bar}, additional_properties: #{get_additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@mini_bar.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
