...
module FortisApi
  ...
  class V1TransactionsCcBalanceInquiryTokenRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcBalanceInquiryTokenRequest.new(additional_amounts: additional_amounts,
    ...
    def inspect
      ...
      " #{@cvv.inspect}, joi: #{@joi.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
