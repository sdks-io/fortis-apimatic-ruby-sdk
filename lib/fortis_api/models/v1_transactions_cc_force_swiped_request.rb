...
module FortisApi
  ...
  class V1TransactionsCcForceSwipedRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(track_data:, auth_code:, additional_amounts: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcForceSwipedRequest.new(track_data: track_data,
                                             auth_code: auth_code,
    ...
    def to_s
      ...
      " #{@account_holder_name}, cvv: #{@cvv}, auth_code: #{@auth_code}, additional_properties:"\
    ...
    def inspect
      ...
      " #{@account_holder_name.inspect}, cvv: #{@cvv.inspect}, auth_code: #{@auth_code.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
