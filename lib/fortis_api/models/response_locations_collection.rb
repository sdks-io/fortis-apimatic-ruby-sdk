...
module FortisApi
  ...
  class ResponseLocationsCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type35Enum::LOCATIONSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type35Enum::LOCATIONSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List6.from_hash(structure) if structure)
        end
      end
      ...
      ResponseLocationsCollection.new(type,
                                      list,
                                      links,
                                      pagination,
                                      sort,
