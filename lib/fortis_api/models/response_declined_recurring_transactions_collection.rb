...
module FortisApi
  ...
  class ResponseDeclinedRecurringTransactionsCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type16Enum::DECLINEDRECURRINGTRANSACTIONSCOLLECTION,
                   list = SKIP, links = SKIP, pagination = SKIP, sort = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type =
        hash['type'] ||= Type16Enum::DECLINEDRECURRINGTRANSACTIONSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List3.from_hash(structure) if structure)
        end
      end
      ...
      ResponseDeclinedRecurringTransactionsCollection.new(type,
                                                          list,
                                                          links,
                                                          pagination,
                                                          sort,
