...
module FortisApi
  ...
  class V1TransactionsCcAuthOnlyKeyedRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(transaction_amount:, account_number:, exp_date:,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcAuthOnlyKeyedRequest.new(transaction_amount: transaction_amount,
                                               account_number: account_number,
                                               exp_date: exp_date,
