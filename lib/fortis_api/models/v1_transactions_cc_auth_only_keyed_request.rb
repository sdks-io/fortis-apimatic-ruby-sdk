...
module FortisApi
  ...
  class V1TransactionsCcAuthOnlyKeyedRequest < BaseModel
    ...
    def initialize(transaction_amount = nil, account_number = nil,
                   exp_date = nil, additional_amounts = SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcAuthOnlyKeyedRequest.new(transaction_amount,
                                               account_number,
                                               exp_date,
                                               additional_amounts,
                                               billing_address,
