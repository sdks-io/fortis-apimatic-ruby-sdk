...
module FortisApi
  ...
  class AltBankAccount2 < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      AltBankAccount2.new(routing_number: routing_number,
    ...
    def inspect
      ...
      " deposit_type: #{@deposit_type.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
