...
module FortisApi
  ...
  class V1TransactionsCcBalanceInquiryWalletRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(wallet_data:, wallet_provider:, additional_amounts: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcBalanceInquiryWalletRequest.new(wallet_data: wallet_data,
                                                      wallet_provider: wallet_provider,
