...
module FortisApi
  ...
  class V1TokensCcRequest1 < BaseModel
    SKIP = Object.new
    ...
    def initialize(account_holder_name: SKIP, account_vault_api_id: SKIP,
                   ...
                   joi: SKIP, exp_date: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      V1TokensCcRequest1.new(account_holder_name: account_holder_name,
    ...
    def to_s
      ...
      " #{@acs_transaction_id}, joi: #{@joi}, exp_date: #{@exp_date}, additional_properties:"\
