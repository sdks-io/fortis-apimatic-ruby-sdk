...
module FortisApi
  ...
  class V1TransactionsCcAuthOnlyTerminalRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(location_id:, transaction_amount:, terminal_id:,
                   ...
                   order_number: SKIP, po_number: SKIP, quick_invoice_id: SKIP,
                   recurring: SKIP, recurring_number: SKIP, room_num: SKIP,
                   room_rate: SKIP, save_account: SKIP,
                   save_account_title: SKIP, subtotal_amount: SKIP,
                   surcharge_amount: SKIP, tags: SKIP, tax: SKIP,
                   tip_amount: SKIP, secondary_amount: SKIP,
                   ...
                   ebt_cash_eligible_amount: SKIP, terminal_api_id: SKIP,
                   e_format: SKIP, e_track_data: SKIP, e_serial_number: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcAuthOnlyTerminalRequest.new(location_id: location_id,
                                                  transaction_amount: transaction_amount,
                                                  terminal_id: terminal_id,
    ...
    def to_s
      ...
      " terminal_id: #{@terminal_id}, terminal_api_id: #{@terminal_api_id}, e_format:"\
      " #{@e_format}, e_track_data: #{@e_track_data}, e_serial_number: #{@e_serial_number},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " ebt_cash_eligible_amount: #{@ebt_cash_eligible_amount.inspect}, terminal_id:"\
      " #{@terminal_id.inspect}, terminal_api_id: #{@terminal_api_id.inspect}, e_format:"\
      " #{@e_format.inspect}, e_track_data: #{@e_track_data.inspect}, e_serial_number:"\
      " #{@e_serial_number.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
