...
module FortisApi
  ...
  class V1TransactionsCcAuthOnlyTerminalRequest < BaseModel
    ...
    def initialize(location_id = nil, transaction_amount = nil,
                   terminal_id = nil, additional_amounts = SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcAuthOnlyTerminalRequest.new(location_id,
                                                  transaction_amount,
                                                  terminal_id,
                                                  additional_amounts,
                                                  billing_address,
    ...
    def inspect
      ...
      " #{@e_serial_number.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
