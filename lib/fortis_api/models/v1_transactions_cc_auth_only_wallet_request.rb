...
module FortisApi
  ...
  class V1TransactionsCcAuthOnlyWalletRequest < BaseModel
    ...
    def initialize(transaction_amount = nil, wallet_data = nil,
                   wallet_provider = nil, additional_amounts = SKIP,
                   ...
                   wallet_key_id = SKIP, additional_properties = {})
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcAuthOnlyWalletRequest.new(transaction_amount,
                                                wallet_data,
                                                wallet_provider,
                                                additional_amounts,
                                                billing_address,
