...
module FortisApi
  ...
  class V1TransactionsCcAuthOnlyWalletRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(transaction_amount:, wallet_data:, wallet_provider:,
                   ...
                   wallet_key_id: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcAuthOnlyWalletRequest.new(transaction_amount: transaction_amount,
                                                wallet_data: wallet_data,
                                                wallet_provider: wallet_provider,
    ...
    def to_s
      ...
      " wallet_provider: #{@wallet_provider}, wallet_key_id: #{@wallet_key_id},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@wallet_provider.inspect}, wallet_key_id: #{@wallet_key_id.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
