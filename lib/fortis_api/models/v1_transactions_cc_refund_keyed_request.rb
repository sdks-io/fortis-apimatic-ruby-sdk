...
module FortisApi
  ...
  class V1TransactionsCcRefundKeyedRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(transaction_amount:, additional_amounts: SKIP,
                   ...
                   account_number: SKIP, cvv: SKIP, entry_mode_id: SKIP,
                   exp_date: SKIP, track_data: SKIP, pin: SKIP, ksn: SKIP,
    ...
    def self.from_hash(hash)
      ...
      account_number = hash.key?('account_number') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:V1TransactionsCcRefundKeyedRequestAccountNumber), hash['account_number']
      ) : SKIP
      cvv = hash.key?('cvv') ? hash['cvv'] : SKIP
      entry_mode_id = hash.key?('entry_mode_id') ? hash['entry_mode_id'] : SKIP
      exp_date = hash.key?('exp_date') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:V1TransactionsCcRefundKeyedRequestExpDate), hash['exp_date']
      ) : SKIP
      ...
      V1TransactionsCcRefundKeyedRequest.new(transaction_amount: transaction_amount,
    ...
    # @param [V1TransactionsCcRefundKeyedRequest | Hash] The value against the validation is performed.
    def self.validate(value)
      if value.instance_of? self
        return APIHelper.valid_type?(value.transaction_amount,
                                     ->(val) { val.instance_of? Integer })
      end

      return false unless value.instance_of? Hash

      APIHelper.valid_type?(value['transaction_amount'],
                            ->(val) { val.instance_of? Integer })
    end
    ...
    def to_s
      ...
      " #{@track_data}, pin: #{@pin}, ksn: #{@ksn}, previous_transaction_id:"\
      " #{@previous_transaction_id}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " previous_transaction_id: #{@previous_transaction_id.inspect}, additional_properties:"\
