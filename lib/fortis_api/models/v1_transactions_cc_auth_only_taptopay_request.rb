...
module FortisApi
  ...
  class V1TransactionsCcAuthOnlyTaptopayRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcAuthOnlyTaptopayRequest.new(card_data_cryptogram: card_data_cryptogram,
                                                  general_card_data: general_card_data,
    ...
    def to_s
      ...
      " #{@card_reader_id}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " card_reader_id: #{@card_reader_id.inspect}, additional_properties:"\
