...
module FortisApi
  ...
  class ResponseTransactionsCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type117Enum::TRANSACTIONSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type117Enum::TRANSACTIONSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List18.from_hash(structure) if structure)
        end
      end
      ...
      ResponseTransactionsCollection.new(type,
                                         list,
                                         links,
                                         pagination,
                                         sort,
