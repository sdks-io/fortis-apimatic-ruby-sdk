...
module FortisApi
  ...
  class ResponseContactSearchsCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type6Enum::CONTACTSEARCHSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type6Enum::CONTACTSEARCHSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List1.from_hash(structure) if structure)
        end
      end
      ...
      ResponseContactSearchsCollection.new(type,
                                           list,
                                           links,
                                           pagination,
                                           sort,
