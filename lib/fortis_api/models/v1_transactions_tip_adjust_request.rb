...
module FortisApi
  ...
  class V1TransactionsTipAdjustRequest < BaseModel
    ...
    def initialize(tip_amount = nil, transaction_amount = nil,
                   ...
                   tax = SKIP, secondary_amount = SKIP,
                   ...
                   ebt_cash_eligible_amount = SKIP, additional_properties = {})
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsTipAdjustRequest.new(tip_amount,
                                         transaction_amount,
                                         additional_amounts,
                                         billing_address,
                                         checkin_date,
