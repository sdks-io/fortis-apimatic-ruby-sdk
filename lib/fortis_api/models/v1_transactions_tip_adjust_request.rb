...
module FortisApi
  ...
  class V1TransactionsTipAdjustRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(tip_amount:, transaction_amount:, additional_amounts: SKIP,
                   ...
                   tax: SKIP, secondary_amount: SKIP, transaction_api_id: SKIP,
                   ...
                   ebt_cash_eligible_amount: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      tip_amount = hash.key?('tip_amount') ? hash['tip_amount'] : nil
      transaction_amount =
      ...
      V1TransactionsTipAdjustRequest.new(tip_amount: tip_amount,
                                         transaction_amount: transaction_amount,
    ...
    def inspect
      ...
      " ebt_cash_eligible_amount: #{@ebt_cash_eligible_amount.inspect}, additional_properties:"\
