...
module FortisApi
  ...
  class V1TransactionsCcBalanceInquiryTerminalRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(location_id:, terminal_id:, additional_amounts: SKIP,
                   ...
                   tip_amount: SKIP, transaction_amount: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcBalanceInquiryTerminalRequest.new(location_id: location_id,
                                                        terminal_id: terminal_id,
