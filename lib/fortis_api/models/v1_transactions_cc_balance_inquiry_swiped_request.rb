...
module FortisApi
  ...
  class V1TransactionsCcBalanceInquirySwipedRequest < BaseModel
    ...
    def initialize(track_data:, additional_amounts: SKIP, billing_address: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcBalanceInquirySwipedRequest.new(track_data: track_data,
    ...
    def to_s
      ...
      " #{@account_holder_name}, cvv: #{@cvv}, additional_properties: #{@additional_properties}>"
    end
