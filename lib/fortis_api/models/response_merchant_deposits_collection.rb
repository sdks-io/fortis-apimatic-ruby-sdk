...
module FortisApi
  ...
  class ResponseMerchantDepositsCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type48Enum::MERCHANTDEPOSITSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type48Enum::MERCHANTDEPOSITSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List8.from_hash(structure) if structure)
        end
      end
      ...
      ResponseMerchantDepositsCollection.new(type,
                                             list,
                                             links,
                                             pagination,
                                             sort,
