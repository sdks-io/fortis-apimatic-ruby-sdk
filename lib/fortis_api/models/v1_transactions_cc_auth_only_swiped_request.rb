...
module FortisApi
  ...
  class V1TransactionsCcAuthOnlySwipedRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(transaction_amount:, track_data:, additional_amounts: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcAuthOnlySwipedRequest.new(transaction_amount: transaction_amount,
                                                track_data: track_data,
