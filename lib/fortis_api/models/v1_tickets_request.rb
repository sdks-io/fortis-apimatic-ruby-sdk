...
module FortisApi
  ...
  class V1TicketsRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      location_id = hash.key?('location_id') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:V1TicketsRequestLocationId), hash['location_id']
      ) : SKIP
      location_api_id =
    ...
    # @param [V1TicketsRequest | Hash] The value against the validation is performed.
    def self.validate(value)
      if value.instance_of? self
        return (
          APIHelper.valid_type?(value.exp_date,
