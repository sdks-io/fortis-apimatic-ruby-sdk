...
module FortisApi
  ...
  class V1TransactionsCashRefundRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(transaction_amount:, additional_amounts: SKIP,
                   ...
                   previous_transaction_id: SKIP, account_holder_name: SKIP,
                   response_message: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCashRefundRequest.new(transaction_amount: transaction_amount,
    ...
    def to_s
      ...
      " #{@auto_decline_zip_override}, ebt_type: #{@ebt_type}, previous_transaction_id:"\
      " #{@previous_transaction_id}, account_holder_name: #{@account_holder_name},"\
      " response_message: #{@response_message}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@ebt_type.inspect}, previous_transaction_id: #{@previous_transaction_id.inspect},"\
      " account_holder_name: #{@account_holder_name.inspect}, response_message:"\
      " #{@response_message.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
