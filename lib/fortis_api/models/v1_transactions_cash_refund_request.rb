...
module FortisApi
  ...
  class V1TransactionsCashRefundRequest < BaseModel
    ...
    def initialize(transaction_amount = nil, additional_amounts = SKIP,
                   ...
                   response_message = SKIP, additional_properties = {})
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCashRefundRequest.new(transaction_amount,
                                          additional_amounts,
                                          billing_address,
                                          checkin_date,
                                          checkout_date,
    ...
    def to_s
      ...
      " response_message: #{@response_message}, additional_properties:"\
    ...
    def inspect
      ...
      " #{@response_message.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
