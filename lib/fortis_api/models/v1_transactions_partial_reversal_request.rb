...
module FortisApi
  ...
  class V1TransactionsPartialReversalRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsPartialReversalRequest.new(transaction_amount: transaction_amount,
    ...
    def to_s
      ...
      " #{@auto_decline_zip_override}, ebt_type: #{@ebt_type}, additional_properties:"\
    ...
    def inspect
      ...
      " #{@ebt_type.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
