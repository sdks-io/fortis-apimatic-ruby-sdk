...
module FortisApi
  ...
  class V1WebhooksTransactionRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(is_active = nil, location_id = nil, on_create = nil,
                   on_update = nil, on_delete = nil,
                   product_transaction_id = nil, number_of_attempts = nil,
                   url = nil, attempt_interval = 300,
                   basic_auth_username = SKIP, basic_auth_password = SKIP,
                   expands = SKIP, format = SKIP, location_api_id = SKIP,
                   legacy = true, postback_config_id = SKIP, resource = SKIP,
    ...
    def self.from_hash(hash)
      ...
      on_create = hash.key?('on_create') ? hash['on_create'] : nil
      on_update = hash.key?('on_update') ? hash['on_update'] : nil
      on_delete = hash.key?('on_delete') ? hash['on_delete'] : nil
      product_transaction_id =
        hash.key?('product_transaction_id') ? hash['product_transaction_id'] : nil
      number_of_attempts =
        hash.key?('number_of_attempts') ? hash['number_of_attempts'] : nil
      ...
      V1WebhooksTransactionRequest.new(is_active,
                                       location_id,
                                       on_create,
                                       on_update,
                                       on_delete,
