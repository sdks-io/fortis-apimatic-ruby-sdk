...
module FortisApi
  ...
  class V1WebhooksTransactionRequest < BaseModel
    ...
    def initialize(is_active:, location_id:, on_create:, on_update:, on_delete:,
                   product_transaction_id:, number_of_attempts:, url:,
                   attempt_interval: 300, basic_auth_username: SKIP,
                   basic_auth_password: SKIP, expands: SKIP, format: SKIP,
                   location_api_id: SKIP, legacy: true,
                   postback_config_id: SKIP, resource: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1WebhooksTransactionRequest.new(is_active: is_active,
                                       location_id: location_id,
                                       on_create: on_create,
                                       on_update: on_update,
                                       on_delete: on_delete,
