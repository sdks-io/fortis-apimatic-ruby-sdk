...
module FortisApi
  ...
  class ResponsePaylinksCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type54Enum::PAYLINKSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type54Enum::PAYLINKSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List9.from_hash(structure) if structure)
        end
      end
      ...
      ResponsePaylinksCollection.new(type,
                                     list,
                                     links,
                                     pagination,
                                     sort,
