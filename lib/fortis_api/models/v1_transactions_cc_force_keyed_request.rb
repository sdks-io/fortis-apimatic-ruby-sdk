...
module FortisApi
  ...
  class V1TransactionsCcForceKeyedRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(account_number:, exp_date:, auth_code:,
                   ...
                   ksn: SKIP, trans_id: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcForceKeyedRequest.new(account_number: account_number,
                                            exp_date: exp_date,
                                            auth_code: auth_code,
    ...
    def to_s
      ...
      " #{@track_data}, pin: #{@pin}, ksn: #{@ksn}, auth_code: #{@auth_code}, trans_id:"\
      " #{@trans_id}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " track_data: #{@track_data.inspect}, pin: #{@pin.inspect}, ksn: #{@ksn.inspect}, auth_code:"\
