...
module FortisApi
  ...
  class V1TransactionsCcForceKeyedRequest < BaseModel
    ...
    def initialize(account_number = nil, exp_date = nil, auth_code = nil,
                   ...
                   pin = SKIP, ksn = SKIP, trans_id = SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcForceKeyedRequest.new(account_number,
                                            exp_date,
                                            auth_code,
                                            additional_amounts,
                                            billing_address,
    ...
    def to_s
      ...
      " #{@trans_id}, additional_properties: #{get_additional_properties}>"
    end
