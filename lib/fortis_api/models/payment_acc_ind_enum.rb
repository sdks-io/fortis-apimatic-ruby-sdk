...
module FortisApi
  ...
  # cardholder's account with the 3DS Requestor. >01 - No account (guest
  # check-out) > >02 - During this transaction > >03 - Less than 30 days > >04 -
  # 30 - 60 days > >05 - More than 60 days >
  class PaymentAccIndEnum
    ...
    def self.validate(value)
      ...
      PAYMENT_ACC_IND_ENUM.include?(value)
    end
