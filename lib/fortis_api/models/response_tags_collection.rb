...
module FortisApi
  ...
  class ResponseTagsCollection < BaseModel
    ...
    def initialize(type = Type78Enum::TAGSCOLLECTION, list = SKIP, links = SKIP,
                   pagination = SKIP, sort = SKIP, additional_properties = {})
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type78Enum::TAGSCOLLECTION
      ...
      ResponseTagsCollection.new(type,
                                 list,
                                 links,
                                 pagination,
                                 sort,
