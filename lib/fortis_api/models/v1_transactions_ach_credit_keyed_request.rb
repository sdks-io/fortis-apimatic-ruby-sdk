...
module FortisApi
  ...
  class V1TransactionsAchCreditKeyedRequest < BaseModel
    ...
    def initialize(transaction_amount = nil, account_holder_name = nil,
                   account_number = nil, account_type = nil,
                   routing_number = nil, additional_amounts = SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsAchCreditKeyedRequest.new(transaction_amount,
                                              account_holder_name,
                                              account_number,
                                              account_type,
                                              routing_number,
