...
module FortisApi
  ...
  class ResponseBatchsCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type1Enum::BATCHSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type1Enum::BATCHSCOLLECTION
      ...
      ResponseBatchsCollection.new(type,
                                   list,
                                   links,
                                   pagination,
                                   sort,
