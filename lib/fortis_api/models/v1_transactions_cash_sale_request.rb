...
module FortisApi
  ...
  class V1TransactionsCashSaleRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(transaction_amount:, additional_amounts: SKIP,
                   ...
                   account_holder_name: SKIP, response_message: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCashSaleRequest.new(transaction_amount: transaction_amount,
    ...
    def to_s
      ...
      " #{@auto_decline_zip_override}, ebt_type: #{@ebt_type}, account_holder_name:"\
      " #{@account_holder_name}, response_message: #{@response_message}, additional_properties:"\
    ...
    def inspect
      ...
      " #{@ebt_type.inspect}, account_holder_name: #{@account_holder_name.inspect},"\
      " response_message: #{@response_message.inspect}, additional_properties:"\
      " #{@additional_properties}>"
    end
  end
end
