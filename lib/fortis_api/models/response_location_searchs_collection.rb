...
module FortisApi
  ...
  class ResponseLocationSearchsCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type31Enum::LOCATIONSEARCHSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type31Enum::LOCATIONSEARCHSCOLLECTION
      ...
      ResponseLocationSearchsCollection.new(type,
                                            list,
                                            links,
                                            pagination,
                                            sort,
