...
module FortisApi
  ...
  class V1TransactionsCcRefundTaptopayRequest < BaseModel
    ...
    def initialize(card_data_cryptogram = nil, general_card_data = nil,
                   ...
                   clerk_id = SKIP, voucher_number = SKIP,
                   ...
                   previous_transaction_id = SKIP, additional_properties = {})
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcRefundTaptopayRequest.new(card_data_cryptogram,
                                                general_card_data,
                                                additional_amounts,
                                                billing_address,
                                                checkin_date,
    ...
    def inspect
      ...
      " #{@previous_transaction_id.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
