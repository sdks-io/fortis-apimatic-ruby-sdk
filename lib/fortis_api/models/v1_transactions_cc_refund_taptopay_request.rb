...
module FortisApi
  ...
  class V1TransactionsCcRefundTaptopayRequest < BaseModel
    SKIP = Object.new
    ...
    # @return [String]
    attr_accessor :card_data_cryptogram

    # Plaintext EMV tags. Used in Tap to Pay transactions
    # @return [String]
    attr_accessor :general_card_data

    # Identifier of card reader used in Tap to Pay transactions.
    # @return [String]
    attr_accessor :card_reader_id

    # previous_transaction_id is used as token to run transaction. Account
    # details OR previous_transaction_id should be passed to run transaction.
    # @return [String]
    ...
    def self.names
      ...
      @_hash['card_data_cryptogram'] = 'card_data_cryptogram'
      @_hash['general_card_data'] = 'general_card_data'
      @_hash['card_reader_id'] = 'card_reader_id'
    ...
    def initialize(card_data_cryptogram:, general_card_data:,
                   ...
                   secure_cryptogram: SKIP,
                   secure_directory_server_transaction_id: SKIP,
                   terminal_serial_number: SKIP, wallet_type: SKIP,
                   clerk_id: SKIP, voucher_number: SKIP, initiation_type: SKIP,
                   bill_payment: SKIP, delay_charge: SKIP, deferred_auth: SKIP,
                   mini_bar: SKIP, ebt_food_eligible_amount: SKIP,
                   ebt_cash_eligible_amount: SKIP, card_reader_id: SKIP,
                   previous_transaction_id: SKIP, additional_properties: nil)
      ...
      @card_reader_id = card_reader_id unless card_reader_id == SKIP
    ...
    def self.from_hash(hash)
      ...
      card_data_cryptogram =
        hash.key?('card_data_cryptogram') ? hash['card_data_cryptogram'] : nil
      general_card_data =
        hash.key?('general_card_data') ? hash['general_card_data'] : nil
      ...
      card_reader_id =
        hash.key?('card_reader_id') ? hash['card_reader_id'] : SKIP
      previous_transaction_id =
      ...
      V1TransactionsCcRefundTaptopayRequest.new(card_data_cryptogram: card_data_cryptogram,
                                                general_card_data: general_card_data,
    ...
    def to_s
      ...
      " #{@auto_decline_zip_override}, ebt_type: #{@ebt_type}, secure_cryptogram:"\
      " #{@secure_cryptogram}, secure_directory_server_transaction_id:"\
      " #{@secure_directory_server_transaction_id}, terminal_serial_number:"\
      " #{@terminal_serial_number}, wallet_type: #{@wallet_type}, clerk_id: #{@clerk_id},"\
      " voucher_number: #{@voucher_number}, initiation_type: #{@initiation_type}, bill_payment:"\
      " #{@bill_payment}, delay_charge: #{@delay_charge}, deferred_auth: #{@deferred_auth},"\
      " mini_bar: #{@mini_bar}, ebt_food_eligible_amount: #{@ebt_food_eligible_amount},"\
      " ebt_cash_eligible_amount: #{@ebt_cash_eligible_amount}, card_data_cryptogram:"\
      " #{@card_data_cryptogram}, general_card_data: #{@general_card_data}, card_reader_id:"\
      " #{@card_reader_id}, previous_transaction_id: #{@previous_transaction_id},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@ebt_type.inspect}, secure_cryptogram: #{@secure_cryptogram.inspect},"\
      ' secure_directory_server_transaction_id:'\
      " #{@secure_directory_server_transaction_id.inspect}, terminal_serial_number:"\
      " #{@terminal_serial_number.inspect}, wallet_type: #{@wallet_type.inspect}, clerk_id:"\
      ...
      " ebt_cash_eligible_amount: #{@ebt_cash_eligible_amount.inspect}, card_data_cryptogram:"\
      " #{@card_data_cryptogram.inspect}, general_card_data: #{@general_card_data.inspect},"\
      " card_reader_id: #{@card_reader_id.inspect}, previous_transaction_id:"\
      " #{@previous_transaction_id.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
