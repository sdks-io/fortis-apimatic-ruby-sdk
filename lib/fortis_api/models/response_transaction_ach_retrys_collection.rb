...
module FortisApi
  ...
  class ResponseTransactionAchRetrysCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type103Enum::TRANSACTIONACHRETRYSCOLLECTION,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type103Enum::TRANSACTIONACHRETRYSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List17.from_hash(structure) if structure)
        end
      end
      ...
      ResponseTransactionAchRetrysCollection.new(type,
                                                 list,
                                                 links,
                                                 pagination,
                                                 sort,
