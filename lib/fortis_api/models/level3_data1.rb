    ...
    def self.from_hash(hash)
      ...
      unless hash['line_items'].nil?
        ...
        hash['line_items'].each do |structure|
          line_items << (LineItem13.from_hash(structure) if structure)
        end
      end
      ...
      Level3Data1.new(destination_country_code: destination_country_code,
