...
module FortisApi
  ...
  class ResponseDeviceTermsCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type23Enum::DEVICETERMSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type23Enum::DEVICETERMSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List4.from_hash(structure) if structure)
        end
      end
      ...
      ResponseDeviceTermsCollection.new(type,
                                        list,
                                        links,
                                        pagination,
                                        sort,
