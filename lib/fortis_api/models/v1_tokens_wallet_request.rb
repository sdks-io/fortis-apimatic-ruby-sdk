...
module FortisApi
  ...
  class V1TokensWalletRequest < BaseModel
    ...
    def initialize(location_id:, wallet_data:, wallet_provider:,
                   ...
                   joi: SKIP, wallet_key_id: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      V1TokensWalletRequest.new(location_id: location_id,
                                wallet_data: wallet_data,
                                wallet_provider: wallet_provider,
    ...
    def inspect
      ...
      " #{@wallet_key_id.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
