...
module FortisApi
  ...
  class V1TransactionsCcForceTicketRequest < BaseModel
    ...
    def initialize(ticket_id:, auth_code:, additional_amounts: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcForceTicketRequest.new(ticket_id: ticket_id,
                                             auth_code: auth_code,
    ...
    def inspect
      ...
      " #{@trans_id.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
