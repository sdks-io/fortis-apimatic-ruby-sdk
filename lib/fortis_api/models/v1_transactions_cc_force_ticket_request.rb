...
module FortisApi
  ...
  class V1TransactionsCcForceTicketRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(ticket_id = nil, auth_code = nil, additional_amounts = SKIP,
                   ...
                   ebt_cash_eligible_amount = SKIP, cvv = SKIP,
    ...
    def self.from_hash(hash)
      ...
      ticket_id = hash.key?('ticket_id') ? hash['ticket_id'] : nil
      ...
      V1TransactionsCcForceTicketRequest.new(ticket_id,
                                             auth_code,
                                             additional_amounts,
                                             billing_address,
                                             checkin_date,
    ...
    def to_s
      ...
      " ticket_id: #{@ticket_id}, cvv: #{@cvv}, account_holder_name: #{@account_holder_name},"\
      " auth_code: #{@auth_code}, trans_id: #{@trans_id}, additional_properties:"\
    ...
    def inspect
      ...
      " ebt_cash_eligible_amount: #{@ebt_cash_eligible_amount.inspect}, ticket_id:"\
      " #{@ticket_id.inspect}, cvv: #{@cvv.inspect}, account_holder_name:"\
      " #{@account_holder_name.inspect}, auth_code: #{@auth_code.inspect}, trans_id:"\
      " #{@trans_id.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
