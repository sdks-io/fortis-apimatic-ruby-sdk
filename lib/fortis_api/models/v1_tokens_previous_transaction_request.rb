...
module FortisApi
  ...
  class V1TokensPreviousTransactionRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(location_id:, previous_transaction_id:,
                   ...
                   previous_token_id: SKIP, account_number: SKIP,
    ...
    def self.from_hash(hash)
      ...
      previous_transaction_id =
        hash.key?('previous_transaction_id') ? hash['previous_transaction_id'] : nil
      account_holder_name =
      ...
      V1TokensPreviousTransactionRequest.new(location_id: location_id,
                                             previous_transaction_id: previous_transaction_id,
    ...
    def to_s
      ...
      " #{@acs_transaction_id}, joi: #{@joi}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@acs_transaction_id.inspect}, joi: #{@joi.inspect}, additional_properties:"\
