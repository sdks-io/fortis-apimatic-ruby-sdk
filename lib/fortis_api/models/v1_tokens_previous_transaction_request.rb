...
module FortisApi
  ...
  class V1TokensPreviousTransactionRequest < BaseModel
    ...
    def initialize(location_id = nil, previous_transaction_id = nil,
    ...
    def self.from_hash(hash)
      ...
      V1TokensPreviousTransactionRequest.new(location_id,
                                             previous_transaction_id,
                                             account_holder_name,
                                             account_vault_api_id,
                                             token_api_id,
    ...
    def to_s
      ...
      " #{@acs_transaction_id}, joi: #{@joi}, additional_properties:"\
