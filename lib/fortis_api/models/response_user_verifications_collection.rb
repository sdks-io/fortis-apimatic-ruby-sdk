...
module FortisApi
  ...
  class ResponseUserVerificationsCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type124Enum::USERVERIFICATIONSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type124Enum::USERVERIFICATIONSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List19.from_hash(structure) if structure)
        end
      end
      ...
      ResponseUserVerificationsCollection.new(type,
                                              list,
                                              links,
                                              pagination,
                                              sort,
