...
module FortisApi
  ...
  class V1TransactionsAchCreditPrevTrxnRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      identity_verification = IdentityVerification27.from_hash(hash['identity_verification']) if
      ...
      V1TransactionsAchCreditPrevTrxnRequest.new(transaction_amount,
                                                 additional_amounts,
                                                 billing_address,
                                                 checkin_date,
                                                 checkout_date,
