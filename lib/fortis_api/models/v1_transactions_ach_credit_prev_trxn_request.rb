...
module FortisApi
  ...
  class V1TransactionsAchCreditPrevTrxnRequest < BaseModel
    SKIP = Object.new
    ...
    # previous_transaction_api_id is used as token to run transaction. Account
    # details OR previous_transaction_api_id should be passed to run
    # transaction.
    # @return [String]
    attr_accessor :previous_transaction_api_id
    ...
    def self.names
      ...
      @_hash['previous_transaction_api_id'] = 'previous_transaction_api_id'
      @_hash['joi'] = '_joi'
      @_hash
    end
    ...
    def initialize(transaction_amount:, additional_amounts: SKIP,
                   ...
                   effective_date: SKIP, account_holder_name: SKIP,
                   previous_transaction_id: SKIP,
                   previous_transaction_api_id: SKIP, joi: SKIP,
      ...
      unless previous_transaction_api_id == SKIP
        @previous_transaction_api_id =
          previous_transaction_api_id
      end
    ...
    def self.from_hash(hash)
      ...
      previous_transaction_api_id =
        hash.key?('previous_transaction_api_id') ? hash['previous_transaction_api_id'] : SKIP
      joi = Joi27.from_hash(hash['_joi']) if hash['_joi']
      ...
      V1TransactionsAchCreditPrevTrxnRequest.new(transaction_amount: transaction_amount,
    ...
    def to_s
      ...
      " #{@account_holder_name}, previous_transaction_id: #{@previous_transaction_id},"\
      " previous_transaction_api_id: #{@previous_transaction_api_id}, joi: #{@joi},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@account_holder_name.inspect}, previous_transaction_id:"\
      " #{@previous_transaction_id.inspect}, previous_transaction_api_id:"\
      " #{@previous_transaction_api_id.inspect}, joi: #{@joi.inspect}, additional_properties:"\
