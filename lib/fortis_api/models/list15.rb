  ...
  class List15 < BaseModel
    ...
    def self.from_hash(hash)
      ...
      location_id = hash.key?('location_id') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:List15LocationId), hash['location_id']
      ) : SKIP
      location_api_id =
      ...
      List15.new(account_holder_name: account_holder_name,
                 exp_date: exp_date,
                 cvv: cvv,
    ...
    # @param [List15 | Hash] The value against the validation is performed.
