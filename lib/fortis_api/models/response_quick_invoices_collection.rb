...
module FortisApi
  ...
  class ResponseQuickInvoicesCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type62Enum::QUICKINVOICESCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type62Enum::QUICKINVOICESCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List10.from_hash(structure) if structure)
        end
      end
      ...
      ResponseQuickInvoicesCollection.new(type,
                                          list,
                                          links,
                                          pagination,
                                          sort,
