...
module FortisApi
  ...
  class V1TokensAchRequest1 < BaseModel
    SKIP = Object.new
    ...
    def initialize(account_holder_name = SKIP, account_vault_api_id = SKIP,
                   ...
                   joi = SKIP, account_type = SKIP, additional_properties = {})
    ...
    def self.from_hash(hash)
      ...
      V1TokensAchRequest1.new(account_holder_name,
                              account_vault_api_id,
                              token_api_id,
                              accountvault_c1,
                              accountvault_c2,
    ...
    def to_s
      ...
      " #{@acs_transaction_id}, joi: #{@joi}, account_type: #{@account_type},"\
    ...
    def inspect
      ...
      " #{@account_type.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
