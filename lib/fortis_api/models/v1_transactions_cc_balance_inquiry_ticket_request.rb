...
module FortisApi
  ...
  class V1TransactionsCcBalanceInquiryTicketRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(ticket_id:, additional_amounts: SKIP, billing_address: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcBalanceInquiryTicketRequest.new(ticket_id: ticket_id,
    ...
    def inspect
      ...
      " #{@account_holder_name.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
