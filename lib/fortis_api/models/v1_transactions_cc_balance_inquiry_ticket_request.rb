...
module FortisApi
  ...
  class V1TransactionsCcBalanceInquiryTicketRequest < BaseModel
    ...
    def initialize(ticket_id = nil, additional_amounts = SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcBalanceInquiryTicketRequest.new(ticket_id,
                                                      additional_amounts,
                                                      billing_address,
                                                      checkin_date,
                                                      checkout_date,
    ...
    def inspect
      ...
      " #{@account_holder_name.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
