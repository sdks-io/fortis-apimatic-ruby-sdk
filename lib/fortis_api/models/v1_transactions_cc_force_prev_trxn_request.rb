...
module FortisApi
  ...
  class V1TransactionsCcForcePrevTrxnRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(auth_code:, additional_amounts: SKIP, billing_address: SKIP,
                   ...
                   ebt_cash_eligible_amount: SKIP,
                   previous_transaction_id: SKIP,
                   previous_transaction_api_id: SKIP, joi: SKIP, cvv: SKIP,
                   account_holder_name: SKIP, trans_id: SKIP,
      ...
      @auth_code = auth_code
      @trans_id = trans_id unless trans_id == SKIP
    ...
    def self.from_hash(hash)
      ...
      trans_id = hash.key?('trans_id') ? hash['trans_id'] : SKIP
      ...
      V1TransactionsCcForcePrevTrxnRequest.new(auth_code: auth_code,
    ...
    def to_s
      ...
      " previous_transaction_id: #{@previous_transaction_id}, previous_transaction_api_id:"\
      " #{@previous_transaction_api_id}, joi: #{@joi}, cvv: #{@cvv}, account_holder_name:"\
      " #{@account_holder_name}, auth_code: #{@auth_code}, trans_id: #{@trans_id},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " ebt_cash_eligible_amount: #{@ebt_cash_eligible_amount.inspect}, previous_transaction_id:"\
      " #{@previous_transaction_id.inspect}, previous_transaction_api_id:"\
      " #{@previous_transaction_api_id.inspect}, joi: #{@joi.inspect}, cvv: #{@cvv.inspect},"\
      " account_holder_name: #{@account_holder_name.inspect}, auth_code: #{@auth_code.inspect},"\
      " trans_id: #{@trans_id.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
