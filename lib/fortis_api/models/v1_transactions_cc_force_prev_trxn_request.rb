...
module FortisApi
  ...
  class V1TransactionsCcForcePrevTrxnRequest < BaseModel
    ...
    def initialize(auth_code = nil, additional_amounts = SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcForcePrevTrxnRequest.new(auth_code,
                                               additional_amounts,
                                               billing_address,
                                               checkin_date,
                                               checkout_date,
    ...
    def inspect
      ...
      " trans_id: #{@trans_id.inspect}, additional_properties: #{get_additional_properties}>"
    end
  end
end
