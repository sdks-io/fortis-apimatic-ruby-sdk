...
module FortisApi
  ...
  class V1TransactionsEbtVoucherClearRefundKeyedRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsEbtVoucherClearRefundKeyedRequest.new(account_number: account_number,
                                                          exp_date: exp_date,
                                                          auth_code: auth_code,
    ...
    def to_s
      ...
      " #{@track_data}, pin: #{@pin}, ksn: #{@ksn}, auth_code: #{@auth_code},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@auth_code.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
