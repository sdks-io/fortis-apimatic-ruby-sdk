...
module FortisApi
  ...
  class V1TransactionsCcForceWalletRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(wallet_data:, wallet_provider:, auth_code:,
                   ...
                   wallet_key_id: SKIP, trans_id: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcForceWalletRequest.new(wallet_data: wallet_data,
                                             wallet_provider: wallet_provider,
                                             auth_code: auth_code,
    ...
    def to_s
      ...
      " account_holder_name: #{@account_holder_name}, wallet_data: #{@wallet_data},"\
      " wallet_provider: #{@wallet_provider}, wallet_key_id: #{@wallet_key_id}, auth_code:"\
      " #{@auth_code}, trans_id: #{@trans_id}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@account_holder_name.inspect}, wallet_data: #{@wallet_data.inspect}, wallet_provider:"\
      " #{@wallet_provider.inspect}, wallet_key_id: #{@wallet_key_id.inspect}, auth_code:"\
      " #{@auth_code.inspect}, trans_id: #{@trans_id.inspect}, additional_properties:"\
