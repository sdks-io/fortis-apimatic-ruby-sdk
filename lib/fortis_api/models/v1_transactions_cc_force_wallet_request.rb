...
module FortisApi
  ...
  class V1TransactionsCcForceWalletRequest < BaseModel
    ...
    def initialize(wallet_data = nil, wallet_provider = nil, auth_code = nil,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcForceWalletRequest.new(wallet_data,
                                             wallet_provider,
                                             auth_code,
                                             additional_amounts,
                                             billing_address,
    ...
    def to_s
      ...
      " #{@auth_code}, trans_id: #{@trans_id}, additional_properties:"\
