...
module FortisApi
  ...
  class V1TransactionsCcAuthOnlyTicketRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(transaction_amount:, ticket_id:, additional_amounts: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcAuthOnlyTicketRequest.new(transaction_amount: transaction_amount,
                                                ticket_id: ticket_id,
