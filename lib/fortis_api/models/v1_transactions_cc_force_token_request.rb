...
module FortisApi
  ...
  class V1TransactionsCcForceTokenRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(auth_code:, additional_amounts: SKIP, billing_address: SKIP,
                   ...
                   token_api_id: SKIP, cvv: SKIP, joi: SKIP, trans_id: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsCcForceTokenRequest.new(auth_code: auth_code,
    ...
    def inspect
      ...
      " #{@cvv.inspect}, joi: #{@joi.inspect}, auth_code: #{@auth_code.inspect}, trans_id:"\
