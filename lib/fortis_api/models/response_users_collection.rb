...
module FortisApi
  ...
  class ResponseUsersCollection < BaseModel
    SKIP = Object.new
    ...
    def initialize(type = Type130Enum::USERSCOLLECTION, list = SKIP,
    ...
    def self.from_hash(hash)
      ...
      type = hash['type'] ||= Type130Enum::USERSCOLLECTION
      # Parameter is an array, so we need to iterate through it
      list = nil
      unless hash['list'].nil?
        list = []
        hash['list'].each do |structure|
          list << (List20.from_hash(structure) if structure)
        end
      end
      ...
      ResponseUsersCollection.new(type,
                                  list,
                                  links,
                                  pagination,
                                  sort,
