  ...
  class Joi18 < BaseModel
    ...
    def self.from_hash(hash)
      ...
      conditions = hash.key?('conditions') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:Joi18Conditions), hash['conditions']
      ) : SKIP
      ...
      Joi18.new(conditions: conditions,
                additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [Joi18 | Hash] The value against the validation is performed.
