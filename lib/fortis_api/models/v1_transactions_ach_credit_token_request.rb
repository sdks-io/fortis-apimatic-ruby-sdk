...
module FortisApi
  ...
  class V1TransactionsAchCreditTokenRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(transaction_amount:, additional_amounts: SKIP,
                   ...
                   account_vault_id: SKIP, token_id: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V1TransactionsAchCreditTokenRequest.new(transaction_amount: transaction_amount,
    ...
    def to_s
      ...
      " #{@account_holder_name}, account_vault_id: #{@account_vault_id}, token_id: #{@token_id},"\
      " account_vault_api_id: #{@account_vault_api_id}, token_api_id: #{@token_api_id}, joi:"\
      " #{@joi}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@account_holder_name.inspect}, account_vault_id: #{@account_vault_id.inspect}, token_id:"\
      " #{@token_id.inspect}, account_vault_api_id: #{@account_vault_api_id.inspect},"\
      " token_api_id: #{@token_api_id.inspect}, joi: #{@joi.inspect}, additional_properties:"\
