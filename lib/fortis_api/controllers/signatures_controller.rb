...
module FortisApi
  ...
  class SignaturesController < BaseController
    ...
    # @param [V1SignaturesRequest] body Required parameter: TODO: type
    # description here
    # @param [Array[Expand34Enum]] expand Optional parameter: Most endpoints in
    ...
    def create_a_new_signature_record(body,
      ...
      @api_call
        ...
        .response(new_response_handler
                    ...
                    .deserialize_into(ResponseSignature.method(:from_hash))
                    .local_error('401',
                                 'Unauthorized',
    ...
    # @param [Array[Field45Enum]] fields Optional parameter: You can use any
    ...
    def list_all_signatures_record(page: nil,
      ...
      @api_call
        ...
        .response(new_response_handler
                    .deserializer(APIHelper.method(:custom_type_deserializer))
                    .deserialize_into(ResponseSignaturesCollection.method(:from_hash))
                    .local_error('401',
                                 'Unauthorized',
                                 Response401tokenException))
        .execute
    ...
    # TODO: type endpoint description here
    # @param [String] signature_id Required parameter: Signature ID
    # @param [Array[Expand34Enum]] expand Optional parameter: Most endpoints in
    # the API have a way to retrieve extra data related to the current record
    # being retrieved. For example, if the API request is for the accountvaults
    # endpoint, and the end user also needs to know which contact the token
    ...
    def view_single_signature_record(signature_id,
      ...
      @api_call
        .request(new_request_builder(HttpMethodEnum::GET,
                                     ...
                                     Server::DEFAULT)
                   .template_param(new_parameter(signature_id, key: 'signature_id')
                                    .should_encode(true))
                   .query_param(new_parameter(expand, key: 'expand'))
                   .query_param(new_parameter(fields, key: 'fields'))
                   .header_param(new_parameter('application/json', key: 'accept'))
