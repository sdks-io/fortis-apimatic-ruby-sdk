...
module FortisApi
  ...
  class TransactionACHRetriesController < BaseController
    ...
    # @param [V1TransactionAchRetriesRequest] body Required parameter: TODO:
    # type description here
    # @param [Array[Expand57Enum]] expand Optional parameter: Most endpoints in
    ...
    def create_a_transaction_ach_retry(body,
      ...
      @api_call
        ...
        .response(new_response_handler
                    ...
                    .deserialize_into(ResponseTransactionAchRetry.method(:from_hash))
                    .local_error('401',
                                 'Unauthorized',
    ...
    # @param [Array[Field55Enum]] fields Optional parameter: You can use any
    ...
    def list_all_transaction_ach_retries_related(page: nil,
      ...
      @api_call
        ...
        .response(new_response_handler
                    .deserializer(APIHelper.method(:custom_type_deserializer))
                    .deserialize_into(ResponseTransactionAchRetrysCollection.method(:from_hash))
                    .local_error('401',
                                 'Unauthorized',
                                 Response401tokenException))
        .execute
    ...
    # TODO: type endpoint description here
    # @param [String] transaction_ach_retry_id Required parameter: Transaction
    # ACH Retry ID.
    # @param [Array[Expand57Enum]] expand Optional parameter: Most endpoints in
    # the API have a way to retrieve extra data related to the current record
    # being retrieved. For example, if the API request is for the accountvaults
    ...
    def view_single_transaction_ach_retry_record(transaction_ach_retry_id,
      ...
      @api_call
        .request(new_request_builder(HttpMethodEnum::GET,
                                     ...
                                     Server::DEFAULT)
                   .template_param(new_parameter(transaction_ach_retry_id, key: 'transaction_ach_retry_id')
                                    .should_encode(true))
                   .query_param(new_parameter(expand, key: 'expand'))
                   .query_param(new_parameter(fields, key: 'fields'))
                   .header_param(new_parameter('application/json', key: 'accept'))
