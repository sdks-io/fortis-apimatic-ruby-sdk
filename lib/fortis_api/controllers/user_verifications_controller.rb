...
module FortisApi
  ...
  class UserVerificationsController < BaseController
    ...
    # @param [String] user_verification_id Required parameter: TODO: type
    # description here
    ...
    def get_user_verification(user_verification_id)
      @api_call
        .request(new_request_builder(HttpMethodEnum::GET,
                                     ...
                                     Server::DEFAULT)
                   .template_param(new_parameter(user_verification_id, key: 'user_verification_id')
                                    .should_encode(true))
                   .header_param(new_parameter('application/json', key: 'accept'))
                   .auth(And.new('user-id', 'user-api-key', 'developer-id')))
        .response(new_response_handler
                    .deserializer(APIHelper.method(:custom_type_deserializer))
                    .deserialize_into(ResponseUserVerification.method(:from_hash))
                    .local_error('401',
                                 'Unauthorized',
    ...
    # @param [Array[Field59Enum]] fields Optional parameter: You can use any
    ...
    def list_user_verifications(page: nil,
      ...
      @api_call
        ...
        .response(new_response_handler
                    .deserializer(APIHelper.method(:custom_type_deserializer))
                    .deserialize_into(ResponseUserVerificationsCollection.method(:from_hash))
                    .local_error('401',
                                 'Unauthorized',
                                 Response401tokenException))
        .execute
