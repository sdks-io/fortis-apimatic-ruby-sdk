...
module FortisApi
  ...
  class TicketsController < BaseController
    ...
    # @param [V1TicketsRequest] body Required parameter: TODO: type description
    # here
    # @param [Array[Expand44Enum]] expand Optional parameter: Most endpoints in
    ...
    def create_a_ticket_record(body,
      ...
      @api_call
        ...
        .response(new_response_handler
                    ...
                    .deserialize_into(ResponseTicket.method(:from_hash))
                    .local_error('401',
                                 'Unauthorized',
    ...
    # @param [Array[Field51Enum]] fields Optional parameter: You can use any
    ...
    def list_all_tickets_related(page: nil,
      ...
      @api_call
        ...
        .response(new_response_handler
                    .deserializer(APIHelper.method(:custom_type_deserializer))
                    .deserialize_into(ResponseTicketsCollection.method(:from_hash))
                    .local_error('401',
                                 'Unauthorized',
                                 Response401tokenException))
        .execute
    ...
    # TODO: type endpoint description here
    # @param [String] ticket_id Required parameter: A unique, system-generated
    ...
    def view_single_ticket_record(ticket_id,
      ...
      @api_call
        .request(new_request_builder(HttpMethodEnum::GET,
                                     ...
                                     Server::DEFAULT)
                   .template_param(new_parameter(ticket_id, key: 'ticket_id')
                                    .should_encode(true))
                   .query_param(new_parameter(expand, key: 'expand'))
                   .query_param(new_parameter(fields, key: 'fields'))
                   .header_param(new_parameter('application/json', key: 'accept'))
